...
export default function ProductForm({
  ...
  const title =
    mode === "edit" ? "Редактирование товара" : "Добавление нового товара";
  ...
  const handleSubmit = (e) => {
    ...
    onSubmit({
      ...
      image:
        formData.image || "https://via.placeholder.com/300x200?text=Product",
    });
  };
        ...
        <form className="modal__form" onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input
              ...
              placeholder="Например, Щитки Adidas Predator"
              autoFocus
            />
            {errors.name && (
